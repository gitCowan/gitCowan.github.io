...
class Accredit extends Controller
{
    ...
    public function ifnull()
    {
        ...
        if($con == NULL){
            $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx1974c1f0f7d6ca40&redirect_uri=https%3a%2f%2faabf51c1.ngrok.io%2findex%2fAccredit%2findex&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
            header("Location: $url");
            //$con = $this->index($code);
        }
